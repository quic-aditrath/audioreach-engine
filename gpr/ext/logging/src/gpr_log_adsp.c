...
static gpr_log_history_t gpr_log_history_modem;
...
GPR_INTERNAL uint32_t gpr_log_init(void)
{
   ...
   (void)ar_mem_cpy(gpr_log_history_modem.start_marker, sizeof(gpr_log_history_modem.start_marker), "GPRSTART", 8);
   gpr_log_history_modem.size = GPR_LOG_HISTORY_BYTE_SIZE_V;
   (void)ar_mem_set(gpr_log_history_modem.log, 0xFF, sizeof(gpr_log_history_modem.log));
   (void)ar_mem_cpy(gpr_log_history_modem.end_marker, sizeof(gpr_log_history_modem.end_marker), "GPR STOP", 8);

   gpr_log_history_modem.log_payloads = 0;
   ...
   gpr_log_history_modem.log_payloads   = 1;
...
GPR_INTERNAL int32_t gpr_log_packet(gpr_packet_t *packet)
{
   ...
   gpr_log_history_t *gpr_log_history;
   ...
   {
      gpr_log_history = &gpr_log_history_modem;
   }
   else
   {
      gpr_log_history = &gpr_log_history_generic;
   }
