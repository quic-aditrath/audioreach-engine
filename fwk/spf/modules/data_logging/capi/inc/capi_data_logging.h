#ifndef __CAPI_AUDIO_LOGGING_H
#define __CAPI_AUDIO_LOGGING_H
/**
 * \file capi_data_logging.h
 * \brief
 *  
 * 
 * \copyright
 ...
 */
capi_err_t capi_data_logging_get_static_properties(capi_proplist_t *init_set_prop_ptr,
