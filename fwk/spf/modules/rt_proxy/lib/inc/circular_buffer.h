...
// Redefining function names to avoid linking errors.
#define circ_buf_alloc rtc_circ_buf_alloc
#define circ_buf_register_client rtc_circ_buf_register_client
#define circ_buf_read rtc_circ_buf_read
#define circ_buf_write rtc_circ_buf_write
#define circ_buf_read_adjust rtc_circ_buf_read_adjust
#define circ_buf_read_client_resize rtc_circ_buf_read_client_resize
#define circ_buf_memset rtc_circ_buf_memset
#define circ_buf_deregister_client rtc_circ_buf_deregister_client
#define circ_buf_free rtc_circ_buf_free
 ...
 * return : circbuf_result
 */
circbuf_result_t circ_buf_read(circ_buf_client_t *rd_handle, int8_t *out_ptr, uint32_t bytes_to_read);
 ...
 * return : circbuf_result
 */
circbuf_result_t circ_buf_memset(circ_buf_client_t *wr_handle, uint8_t write_value, uint32_t num_bytes);
/*
 * Initializes the Circular buffer
