#ifndef CAPI_GAIN_MODULE_UTILS_H
#define CAPI_GAIN_MODULE_UTILS_H
/**
 * \file capi_gain_module_structs.h
 *  
 * \brief
 *  
 *     Example Gain Module
...
#define CAPI_GAIN_MODULE_KPPS_8KHZ_MONO_CH 30
#define CAPI_GAIN_MODULE_MAX_IN_PORTS 1
...
typedef struct capi_gain_module_events_info
{
   ...
   uint32_t code_bw;
   uint32_t data_bw;
} capi_gain_module_events_info_t;

/* Struct to store gain module config*/
typedef struct capi_gain_module_configuration
{
   uint32_t enable;
   ...
   uint16_t gain_q12;
} capi_gain_module_configuration_t;

typedef struct capi_gain_module_t
{
   ...
   capi_gain_module_events_info_t events_info;

   /* Struct to store gain configuration*/
   capi_gain_module_configuration_t gain_config;
 ...
 * -----------------------------------------------------------------------*/
/* For all functions in capi_gain_module_utils being called from capi_gain_module*/
...
#endif // CAPI_GAIN_MODULE_UTILS_H
